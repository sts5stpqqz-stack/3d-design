...
import logoTrimmedPath from "@assets/311designs_logo_trimmed.png";
...
function LogoLockup({ opacity = 1 }: { opacity?: number }) {
  return (
    <div
      style={{
        WebkitMaskImage: `url(${logoTrimmedPath})`,
        maskImage: `url(${logoTrimmedPath})`,
